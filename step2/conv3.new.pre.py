...
def process_conv_output(conv_output, base_dir, min_x_values, channel_name_y_values, kernel_height=20, kernel_width=100, stride_height=1, stride_width=1):
    for i, output in enumerate(conv_output):
...
# 产生images
images, min_x_values, max_range = generate_images(file_path_origin, result, chunk_size=chunk_size)
